...
The Reedelk Transformer plugin can be installed with the following command. The .rock package can be downloaded from this repository.
...
In order to use the plugin, you must register the plugin in the kong.conf file by adding the plugin name in the plugins property list
